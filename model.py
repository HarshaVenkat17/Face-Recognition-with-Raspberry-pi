...
harsha_image = face_recognition.load_image_file("harsha.jpg")
...
manas_image = face_recognition.load_image_file("manas.jpg")
manas_face_encoding = face_recognition.face_encodings(manas_image)[0]



amit_image = face_recognition.load_image_file("amit.jpg")pip
